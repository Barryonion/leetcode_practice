...
public class LRUBaseHashTable<K, V> {
    ...
    public static void main(String[] args) {
        ...
        lruBaseHashTable.add(4,"d");
        lruBaseHashTable.add(5,"e");
        lruBaseHashTable.add(6,"f");
        lruBaseHashTable.add(7,"g");
        lruBaseHashTable.add(8,"h");
        lruBaseHashTable.add(9,"i");
        lruBaseHashTable.add(10,"j");
        lruBaseHashTable.add(11,"k");
